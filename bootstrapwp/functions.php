...
function bootstrapwp_scripts() {
	...
	wp_enqueue_style( 'font-awesome', get_template_directory_uri() . '/css/fontawesome.min.css', array(), '5.12.1', 'all' );

	wp_enqueue_style( 'bootstrapwp-styles', get_template_directory_uri() ) ;
...
if( !function_exists('ie_scripts')) {
	function ie_scripts() {
	    ...
	    echo ' <script src="https://oss.maxcdn.com/respond/1.4.2/respond.min.js"></script>';	//update to the latest version
	   	echo ' <![endif]-->';
   	}
